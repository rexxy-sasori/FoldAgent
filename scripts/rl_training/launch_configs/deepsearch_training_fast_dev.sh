...
+actor_rollout_ref.rollout.engine_kwargs.sglang.context_length=24576 \
+actor_rollout_ref.rollout.engine_kwargs.sglang.allow_auto_truncate=true \
+actor_rollout_ref.rollout.engine_kwargs.sglang.max_running_requests=48 \
...
+actor_rollout_ref.rollout.plugin.max_turns=8 \
+actor_rollout_ref.rollout.plugin.val_max_turns=12 \

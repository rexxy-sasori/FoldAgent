...
+actor_rollout_ref.rollout.engine_kwargs.sglang.context_length=12288 \
+actor_rollout_ref.rollout.engine_kwargs.sglang.allow_auto_truncate=true \
+actor_rollout_ref.rollout.plugin.workflow=search \
+actor_rollout_ref.rollout.plugin.max_turns=16 \
+actor_rollout_ref.rollout.plugin.val_max_turns=50 \
+actor_rollout_ref.rollout.plugin.session_timeout=1350 \
